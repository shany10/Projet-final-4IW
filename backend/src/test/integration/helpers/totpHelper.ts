...
// generer de vrais codes 2FA cote test : totp.ts n'exporte pas de generateur.
// La fenetre serveur de +-1 periode rend l'horloge reelle suffisante.
...
// Un code garanti different du code courant (et hors fenetre a toute
// probabilite raisonnable).
